...
Required Notice: 本软件禁止一切商业用途。特别禁止下列行为及其类似变种:在淘宝、闲鱼(咸鱼)、拼多多、京东、抖音小店、快手小店、微店、转转等一切电商平台或二手交易平台上售卖本软件或其修改版本;以本软件为基础提供收费安装、代部署、代维护服务;将本软件捆绑进任何收费商品或服务中倒卖牟利。商业授权请联系作者(在 GitHub 仓库提 Issue)。

┌─────────────────【中文说明(帮助理解,以下方英文原文为准)】─────────────────┐
│ 本项目采用 PolyForm Noncommercial 1.0.0 许可证,要点如下:                    │
│                                                                              │
│ ✅ 免费允许:个人使用、公司/团队内部自用、学习研究、公益及教育机构使用;      │
│    可以修改、可以转发分享 —— 但必须原样保留上方 Required Notice 声明行。     │
│                                                                              │
│ ❌ 一律禁止:任何商业用途。包括但不限于:售卖本软件、集成进商业产品、        │
│    基于本软件向他人提供收费服务、在电商/二手平台倒卖牟利等类似行为。         │
│                                                                              │
│ 💼 商业授权:确有商用需求,请先联系作者取得书面授权(GitHub 仓库提 Issue)。 │
│                                                                              │
│ ⚠️ 免责:软件按"现状"提供,不含任何担保,作者不对任何损失负责。             │
│ ⏱️ 违约后果:收到书面通知后 32 天内未纠正,你的全部使用授权自动终止。        │
└──────────────────────────────────────────────────────────────────────────────┘
